...
def open_ping(user):
  ...
  for user in user_list:
    ...
    ec2_key = Ec2_keys.objects.get(username = user).ec2_access_key
    ec2_secret = Ec2_keys.objects.get(username = user).ec2_secret_key
    ec2_url = Ec2_keys.objects.get(username = user).ec2_url
